 ...
 * Publish to Modrinth
 */
class PublishModrinthCommand : CliktCommand(
    name = "modrinth",
    help = "Publish mod to Modrinth"
) {
    ...
    override fun run() {
        ...
        try {
            ...
            if (configFile.modrinth == null) {
                Logger.error("Modrinth configuration not found in .dropper/publish-config.yml")
                return
            }
            ...
            // Publish
            val publisher = ModrinthPublisher()
            ...
            Logger.info("Publishing to Modrinth...")
