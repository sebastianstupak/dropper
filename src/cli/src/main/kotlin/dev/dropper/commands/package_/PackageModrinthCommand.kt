...
import dev.dropper.packagers.ModrinthPackager
import dev.dropper.packagers.PackageOptions
import dev.dropper.util.Logger
import java.io.File

/**
 * Package mod for Modrinth distribution
 */
class PackageModrinthCommand : CliktCommand(
    name = "modrinth",
    help = "Package mod for Modrinth with metadata"
) {
