...
import dev.dropper.packagers.CurseForgePackager
import dev.dropper.packagers.PackageOptions
import dev.dropper.util.Logger
import java.io.File

/**
 * Package mod for CurseForge distribution
 */
class PackageCurseForgeCommand : CliktCommand(
    name = "curseforge",
    help = "Package mod for CurseForge with manifest"
) {
