 ...
 */
class RenameEntityCommand : DropperCommand(
    name = "entity",
    ...
    override fun run() {
        ...
        if (discoveredFiles.isEmpty()) {
            Logger.error("Entity '$oldName' not found")
            return
        }
        ...
        if (result.success) {
            if (dryRun) {
                ...
                Logger.success("Successfully renamed entity: $oldName -> $newName")
