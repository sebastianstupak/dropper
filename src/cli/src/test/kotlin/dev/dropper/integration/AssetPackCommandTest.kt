...
class AssetPackCommandTest {
    ...
    @BeforeEach
    fun setup() {
        testProjectDir = File("build/test-asset-pack/${System.currentTimeMillis()}/test-mod")
    ...
    fun `create asset pack with inheritance`() {
        ...
        assertTrue(File(testProjectDir, "versions/shared/v2").exists(), "v2 directory should exist")
        assertTrue(File(testProjectDir, "versions/shared/v2/config.yml").exists(), "v2 config should exist")
        assertTrue(File(testProjectDir, "versions/shared/v2/assets").exists(), "v2 assets should exist")
        assertTrue(File(testProjectDir, "versions/shared/v2/data").exists(), "v2 data should exist")
        assertTrue(File(testProjectDir, "versions/shared/v2/common/src/main/java").exists(), "v2 common/src/main/java should exist")

        // Verify config content
        val config = File(testProjectDir, "versions/shared/v2/config.yml").readText()
    ...
    fun `cascading layers - item in v1 available in v2`() {
        ...
        // Verify item in v1
        val v1Model = File(testProjectDir, "versions/shared/v1/assets/assettest/models/item/emerald_sword.json")
    ...
    fun `override asset in child pack`() {
        ...
        val v1Model = File(testProjectDir, "versions/shared/v1/assets/assettest/models/item/diamond_gem.json")
        ...
        val v2Model = File(testProjectDir, "versions/shared/v2/assets/assettest/models/item/diamond_gem.json")
    ...
    fun `multiple inheritance chain`() {
        ...
        // Verify configs
        val v2Config = File(testProjectDir, "versions/shared/v2/config.yml").readText()
        assertTrue(v2Config.contains("inherits: v1"), "v2 should inherit v1")

        val v3Config = File(testProjectDir, "versions/shared/v3/config.yml").readText()
    ...
    fun `version-specific assets override shared pack`() {
        ...
        val versionOverride = File(testProjectDir, "versions/1_20_1/assets/assettest/models/item/ruby_gem.json")
    ...
    fun `loader-specific assets override everything`() {
        ...
        val loaderOverride = File(testProjectDir, "versions/1_20_1/fabric/assets/assettest/models/item/sapphire_gem.json")
