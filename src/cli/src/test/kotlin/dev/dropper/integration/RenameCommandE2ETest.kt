...
class RenameCommandE2ETest {
    ...
    @BeforeEach
    fun setup() {
        context = TestProjectContext.create("test-rename")
    ...
    fun `test 01 - rename item changes all files`() {
        ...
        // Verify item exists
        val oldItemFile = context.file( "shared/common/src/main/java/com/testrename/items/RubyGem.java")
        assertTrue(oldItemFile.exists(), "Old item should exist before rename")

        // Rename using renamer directly (command would need stdin)
        val renameContext = RenameContext(
        ...
        val newItemFile = context.file( "shared/common/src/main/java/com/testrename/items/SapphireGem.java")
    ...
    fun `test 02 - rename block changes all files`() {
        ...
        val newBlockFile = context.file( "shared/common/src/main/java/com/testrename/blocks/SapphireOre.java")
        assertTrue(newBlockFile.exists(), "New block file should exist")

        // Verify blockstate
        val newBlockstate = context.file( "versions/shared/v1/assets/testrename/blockstates/sapphire_ore.json")
        assertTrue(newBlockstate.exists(), "New blockstate should exist")

        val oldBlockstate = context.file( "versions/shared/v1/assets/testrename/blockstates/ruby_ore.json")
    ...
    fun `test 06 - rename item updates model file`() {
        ...
        val oldModel = context.file( "versions/shared/v1/assets/testrename/models/item/old_item.json")
    ...
    fun `test 08 - rename block updates blockstate`() {
        ...
        val newBlockstate = context.file( "versions/shared/v1/assets/testrename/blockstates/new_block.json")
        assertTrue(newBlockstate.exists(), "New blockstate should exist")
    ...
    fun `test 09 - rename block updates block model`() {
        ...
        val newBlockModel = context.file( "versions/shared/v1/assets/testrename/models/block/new_block.json")
    ...
    fun `test 10 - rename block updates item model`() {
        ...
        val newItemModel = context.file( "versions/shared/v1/assets/testrename/models/item/new_block.json")
    ...
    fun `test 11 - rename item updates recipe references`() {
        ...
        val newRecipe = context.file( "versions/shared/v1/data/testrename/recipe/diamond_sword.json")
        val oldRecipe = context.file( "versions/shared/v1/data/testrename/recipe/ruby_sword.json")
    ...
    fun `test 14 - rename finds all references`() {
        ...
        val renamer = ItemRenamer()
        val discovered = renamer.discover(renameContext)
        val references = renamer.findReferences(renameContext, discovered)
    ...
    fun `test 15 - dry run previews changes without applying`() {
        ...
        val oldFile = context.file( "shared/common/src/main/java/com/testrename/items/TestItem.java")
        assertTrue(oldFile.exists(), "Old file should still exist after dry run")

        // Verify new files don't exist
        val newFile = context.file( "shared/common/src/main/java/com/testrename/items/NewItem.java")
    ...
    fun `test 17 - detect conflict when new name already exists`() {
        ...
        val renamer = ItemRenamer()
        val conflicts = renamer.checkConflicts(renameContext)
    ...
    fun `test 19 - validation passes after successful rename`() {
        ...
        val valid = renamer.validate(renameContext)
    ...
    fun `test 21 - rename multiple items sequentially`() {
        ...
        // Verify all renamed
        assertTrue(
            context.file( "shared/common/src/main/java/com/testrename/items/RenamedA.java").exists(),
            "RenamedA should exist"
        )
        assertTrue(
            context.file( "shared/common/src/main/java/com/testrename/items/RenamedB.java").exists(),
            "RenamedB should exist"
        )
        assertTrue(
            context.file( "shared/common/src/main/java/com/testrename/items/RenamedC.java").exists(),
    ...
    fun `test 22 - rename snake_case to PascalCase class name`() {
        ...
        val newFile = context.file( "shared/common/src/main/java/com/testrename/items/DiamondMagicSword.java")
    ...
    fun `test 24 - rollback on failure restores original files`() {
        ...
        val originalFile = context.file( "shared/common/src/main/java/com/testrename/items/TestItem.java")
    ...
    fun `test 32 - rename with underscores in name`() {
        ...
        val newFile = context.file( "shared/common/src/main/java/com/testrename/items/HyperMegaUltraItem.java")
    ...
    fun `test 33 - rename verifies old files deleted`() {
        ...
        val oldFile = context.file( "shared/common/src/main/java/com/testrename/items/OldItem.java")
    ...
    fun `test 41 - block rename updates all asset types`() {
        ...
        assertTrue(
            context.file( "versions/shared/v1/assets/testrename/blockstates/new_block.json").exists(),
            "Blockstate should exist"
        )
        assertTrue(
            context.file( "versions/shared/v1/assets/testrename/models/block/new_block.json").exists(),
            "Block model should exist"
        )
        assertTrue(
            context.file( "versions/shared/v1/assets/testrename/models/item/new_block.json").exists(),
            "Item model should exist"
        )
        assertTrue(
            context.file( "versions/shared/v1/assets/testrename/textures/block/new_block.png").exists(),
    ...
    fun `test 42 - rename operation is atomic`() {
        ...
        val newExists = context.file( "shared/common/src/main/java/com/testrename/items/NewItem.java").exists()
        val oldExists = context.file( "shared/common/src/main/java/com/testrename/items/TestItem.java").exists()
    ...
    fun `test 48 - comprehensive rename workflow end to end`() {
        ...
        // Verify created
        assertTrue(
            context.file( "shared/common/src/main/java/com/testrename/items/OriginalItem.java").exists(),
        ...
        // Verify final state
        assertTrue(
            context.file( "shared/common/src/main/java/com/testrename/items/RenamedItem.java").exists(),
    ...
    fun `test 50 - stress test with 10 sequential renames`() {
        ...
        // Verify all renamed
        (1..10).forEach { i ->
            val newFile = context.file( "shared/common/src/main/java/com/testrename/items/Renamed$i.java")
            assertTrue(newFile.exists(), "Renamed$i should exist")

            val oldFile = context.file( "shared/common/src/main/java/com/testrename/items/Item$i.java")
