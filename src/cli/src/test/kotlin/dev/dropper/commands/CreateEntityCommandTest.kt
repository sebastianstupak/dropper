...
class CreateEntityCommandTest {
    ...
    fun `test basic mob entity creation`() {
        ...
        val entityClass = FileUtil.readText(File(tempDir, "shared/common/src/main/java/com/testmod/entities/TestMob.java"))
        ...
        val fabricEntity = FileUtil.readText(File(tempDir, "shared/fabric/src/main/java/com/testmod/platform/fabric/TestMobFabric.java"))
        ...
        val forgeEntity = FileUtil.readText(File(tempDir, "shared/forge/src/main/java/com/testmod/platform/forge/TestMobForge.java"))
        ...
        val neoforgeEntity = FileUtil.readText(File(tempDir, "shared/neoforge/src/main/java/com/testmod/platform/neoforge/TestMobNeoForge.java"))
    ...
    fun `test animal entity creation`() {
        ...
        val entityClass = FileUtil.readText(File(tempDir, "shared/common/src/main/java/com/testmod/entities/CustomCow.java"))
    ...
    fun `test monster entity creation`() {
        ...
        val entityClass = FileUtil.readText(File(tempDir, "shared/common/src/main/java/com/testmod/entities/FireDemon.java"))
    ...
    fun `test villager entity creation`() {
        ...
        val entityClass = FileUtil.readText(File(tempDir, "shared/common/src/main/java/com/testmod/entities/CustomVillager.java"))
    ...
    fun `test projectile entity creation`() {
        ...
        val entityClass = FileUtil.readText(File(tempDir, "shared/common/src/main/java/com/testmod/entities/MagicBolt.java"))
        ...
        val modelFile = File(tempDir, "versions/shared/v1/assets/testmod/models/entity/magic_bolt.json")
    ...
    fun `test entity without spawn egg`() {
        ...
        val entityFile = File(tempDir, "shared/common/src/main/java/com/testmod/entities/TestEntity.java")
        assertTrue(entityFile.exists())

        val spawnEggFile = File(tempDir, "shared/common/src/main/java/com/testmod/items/TestEntitySpawnEgg.java")
        assertFalse(spawnEggFile.exists(), "Spawn egg should not be created when --spawn-egg is false")

        val spawnEggModel = File(tempDir, "versions/shared/v1/assets/testmod/models/item/test_entity_spawn_egg.json")
    ...
    fun `test all loader-specific renderer files created`() {
        ...
        val fabricRenderer = File(tempDir, "shared/fabric/src/main/java/com/testmod/client/renderer/fabric/TestMobRenderer.java")
        ...
        val forgeRenderer = File(tempDir, "shared/forge/src/main/java/com/testmod/client/renderer/forge/TestMobRenderer.java")
        ...
        val neoforgeRenderer = File(tempDir, "shared/neoforge/src/main/java/com/testmod/client/renderer/neoforge/TestMobRenderer.java")
    ...
    fun `test entity model generation for mobs`() {
        ...
        val modelFile = File(tempDir, "versions/shared/v1/assets/testmod/models/entity/zombie_guard.json")
    ...
    fun `test spawn egg item registration`() {
        ...
        val spawnEggFile = File(tempDir, "shared/common/src/main/java/com/testmod/items/FriendlySlimeSpawnEgg.java")
        ...
        val modelFile = File(tempDir, "versions/shared/v1/assets/testmod/models/item/friendly_slime_spawn_egg.json")
        assertTrue(modelFile.exists())
        val modelContent = FileUtil.readText(modelFile)
    ...
    fun `test entity with underscores in name`() {
        ...
        val entityFile = File(tempDir, "shared/common/src/main/java/com/testmod/entities/AncientFireDragon.java")
        assertTrue(entityFile.exists())
    ...
    fun `test entity texture placeholder creation`() {
        ...
        val textureFile = File(tempDir, "versions/shared/v1/assets/testmod/textures/entity/crystal_golem.png")
    ...
    fun `test all entity types have correct base class suggestions`() {
        ...
        testCases.forEach { (type, pair) ->
            ...
            val entityFile = File(tempDir, "shared/common/src/main/java/com/testmod/entities/$className.java")
    ...
    fun `test fabric entity dimensions and tracking`() {
        ...
        val fabricEntity = FileUtil.readText(File(tempDir, "shared/fabric/src/main/java/com/testmod/platform/fabric/TestEntityFabric.java"))
    ...
    fun `test forge entity builder configuration`() {
        ...
        val forgeEntity = FileUtil.readText(File(tempDir, "shared/forge/src/main/java/com/testmod/platform/forge/TestEntityForge.java"))
    ...
    fun `test neoforge entity registration pattern`() {
        ...
        val neoforgeEntity = FileUtil.readText(File(tempDir, "shared/neoforge/src/main/java/com/testmod/platform/neoforge/TestEntityNeoForge.java"))
    ...
    fun `test entity model JSON structure`() {
        ...
        val modelFile = File(tempDir, "versions/shared/v1/assets/testmod/models/entity/knight.json")
        val modelContent = FileUtil.readText(modelFile)
