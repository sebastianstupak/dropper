...
```bash
# Textures
versions/shared/v1/assets/testmodcli/textures/item/my_item.png

# Models
versions/shared/v1/assets/testmodcli/models/item/my_item.json

# Recipes
versions/shared/v1/data/testmodcli/recipes/my_item.json
```
