...
```bash
# Textures
versions/shared/v1/assets/testdevmod/textures/item/my_item.png

# Models
versions/shared/v1/assets/testdevmod/models/item/my_item.json

# Recipes
versions/shared/v1/data/testdevmod/recipes/my_item.json
```
